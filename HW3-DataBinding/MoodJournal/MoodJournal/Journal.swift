...
extension Journal {
    static let emptyJournal = Journal(title: "", content: "", time: Date(), fontSize: 18, fontFamily: 0, moodTag: 0)
    static let test1 = Journal(title: "bbb", content: "b", time: Date(), fontSize: 18, fontFamily: 0, moodTag: 0)
    static let test2 = Journal(title: "ccc", content: "c", time: Date(), fontSize: 18, fontFamily: 0, moodTag: 0)
    static let test3 = Journal(title: "ddd", content: "d", time: Date(), fontSize: 18, fontFamily: 0, moodTag: 0)
    static let test4 = Journal(title: "eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", content: "e", time: Date(), fontSize: 18, fontFamily: 0, moodTag: 0)
    
    static let defaultDict = ["無標籤": [test1.id: test1, test2.id: test2],
                              "Aaa": [test3.id: test3, test4.id: test4]]
    
    static let fontFamilyList = ["Yuppy TC Regular", "test"]
